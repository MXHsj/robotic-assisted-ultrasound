...
data_raw = csvread('data/robot_data_log_02_17.csv');  % scan phantom
...
set(gcf, 'Position',  [500, 100, 200*ncol, 200*nrow])
...
ylim([-0.05,0.05])
title('entry2 to target2')
legend('row','pitch','yaw','Location','southwest','NumColumns',1)
...
figure
% subplot(1,4,1)
plot(ftime1./10, Fz(ftime1),'LineWidth',2);
hold on
plot(ftime1./10, Fz_desired*ones(length(ftime1),1),'--r','LineWidth',3)
set(gca, 'YGrid', 'on', 'XGrid', 'off')
...
legend('recorded','desired','FontSize',20)
...
% legend('recorded','desired')
% % axis equal
% % set(gcf, 'Position',  [500, 500, 320, 400])